...
resource "aws_eks_cluster" "this" {
  ...
  vpc_config {
    security_group_ids      = length(var.cluster_override_security_group_ids) > 0 ? var.cluster_override_security_group_ids : distinct(concat(var.cluster_additional_security_group_ids, [local.cluster_security_group_id]))
